...
class Game(GameWorld):
    def __init__(self):
        ...
        for i in range(2):
            Alien(
                288 + i * 40, 60, 2, "Recursos/Alien0-*.png", get_target=self.getTarget
            )
        for i in range(6):
        ...
        for i in range(10):
            Alien(
                128 + i * 40, 100 + 40 * 2, 2, "Recursos/Alien3-*.png", self.getTarget
            )
            Alien(
                128 + i * 40, 100 + 40 * 3, 2, "Recursos/Alien3-*.png", self.getTarget
            )
            Alien(
                128 + i * 40, 100 + 40 * 4, 2, "Recursos/Alien3-*.png", self.getTarget
            )
