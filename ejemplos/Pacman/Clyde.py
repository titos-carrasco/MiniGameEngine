...
class Clyde(Sprite):
    def __init__(self, x, y, layer):
        ...
        self.animLeft = Animator("./Recursos/Clyde/L*", self, speed=0.4)
        self.animRight = Animator("./Recursos/Clyde/R*", self, speed=0.4)
        self.animUp = Animator("./Recursos/Clyde/U*", self, speed=0.4)
        self.animDown = Animator("./Recursos/Clyde/D*", self, speed=0.4)
