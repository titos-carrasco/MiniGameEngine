...
class Pinky(Sprite):
    def __init__(self, x, y, layer):
        ...
        self.animLeft = Animator("./Recursos/Pinky/L*", self, speed=0.4)
        self.animRight = Animator("./Recursos/Pinky/R*", self, speed=0.4)
        self.animUp = Animator("./Recursos/Pinky/U*", self, speed=0.4)
        self.animDown = Animator("./Recursos/Pinky/D*", self, speed=0.4)
